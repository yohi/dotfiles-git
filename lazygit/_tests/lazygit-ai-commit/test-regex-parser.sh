...
OUTPUT=$(cat << 'EOF' | "${SCRIPT_DIR}/_scripts/lazygit-ai-commit/parse-ai-output.sh"
...
OUTPUT=$(echo "test diff" | "${SCRIPT_DIR}/_scripts/lazygit-ai-commit/mock-ai-tool.sh" | "${SCRIPT_DIR}/_scripts/lazygit-ai-commit/parse-ai-output.sh")
