...
- [ ] mockバックエンドが動作: `echo "test" | AI_BACKEND=mock lazygit/_scripts/lazygit-ai-commit/ai-commit-generator.sh`
- [ ] パーサーが動作: `echo "feat: test" | lazygit/_scripts/lazygit-ai-commit/parse-ai-output.sh`
- [ ] 完全なパイプラインが動作: `git diff --cached | lazygit/_scripts/lazygit-ai-commit/ai-commit-generator.sh | lazygit/_scripts/lazygit-ai-commit/parse-ai-output.sh`
...
2. `lazygit/_scripts/lazygit-ai-commit/ai-commit-generator.sh`を完全な絶対パスに置き換える
3. `lazygit/_scripts/lazygit-ai-commit/parse-ai-output.sh`を完全な絶対パスに置き換える
4. LazyGitを再起動
...
git add test.txt
time git diff --cached | lazygit/_scripts/lazygit-ai-commit/ai-commit-generator.sh
...
git add large.bin
time git diff --cached | head -c 12000 | lazygit/_scripts/lazygit-ai-commit/ai-commit-generator.sh
```
