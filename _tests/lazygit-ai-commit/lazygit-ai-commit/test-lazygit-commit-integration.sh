...
MESSAGES=$(echo "$DIFF" | head -c 12000 | AI_TOOL="$SCRIPT_DIR/../../_scripts/lazygit-ai-commit/mock-ai-tool.sh" "$SCRIPT_DIR/../../_scripts/lazygit-ai-commit/ai-commit-generator.sh" 2>&1 | "$SCRIPT_DIR/../../_scripts/lazygit-ai-commit/parse-ai-output.sh" 2>&1)
