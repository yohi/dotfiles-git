...
OUTPUT=$(cat << 'EOF' | ../../_scripts/lazygit-ai-commit/parse-ai-output.sh
...
OUTPUT=$(echo "test diff" | ../../_scripts/lazygit-ai-commit/mock-ai-tool.sh | ../../_scripts/lazygit-ai-commit/parse-ai-output.sh)
